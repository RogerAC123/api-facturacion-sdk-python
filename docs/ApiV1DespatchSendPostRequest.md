...
**guia_partida_geo** | [**ApiV1DespatchSendPostRequestGuiaPartidaGeo**](ApiV1DespatchSendPostRequestGuiaPartidaGeo.md) |  | [optional] 
...
json = "{}"
# create an instance of ApiV1DespatchSendPostRequest from a JSON string
api_v1_despatch_send_post_request_instance = ApiV1DespatchSendPostRequest.from_json(json)
# print the JSON string representation of the object
print(ApiV1DespatchSendPostRequest.to_json())

# convert the object into a dict
api_v1_despatch_send_post_request_dict = api_v1_despatch_send_post_request_instance.to_dict()
# create an instance of ApiV1DespatchSendPostRequest from a dict
api_v1_despatch_send_post_request_from_dict = ApiV1DespatchSendPostRequest.from_dict(api_v1_despatch_send_post_request_dict)
```
