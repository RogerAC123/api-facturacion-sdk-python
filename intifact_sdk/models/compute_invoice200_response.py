...
class ComputeInvoice200Response(BaseModel):
    """
    ComputeInvoice200Response
    """ # noqa: E501
    success: StrictBool
    message: Optional[StrictStr]
    data: ComputeInvoice200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ComputeInvoice200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
