...
class ApiV1CatalogsGet200ResponseDataInner(BaseModel):
    """
    ApiV1CatalogsGet200ResponseDataInner
    """ # noqa: E501
    key: Optional[StrictStr]
    name: Optional[StrictStr]
    items: List[ApiV1CatalogsGet200ResponseDataInnerItemsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "name": obj.get("name"),
            "items": [ApiV1CatalogsGet200ResponseDataInnerItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
