...
class ApiV1SummarySendPost202Response(BaseModel):
    """
    ApiV1SummarySendPost202Response
    """ # noqa: E501
    success: StrictBool
    message: Optional[StrictStr]
    data: Optional[ApiV1SummarySendPost202ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ApiV1SummarySendPost202ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
