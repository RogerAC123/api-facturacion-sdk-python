...
class SendDespatchMulti202ResponseDataGuiasInner(BaseModel):
    """
    ...
    data: Optional[SendInvoice202ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SendInvoice202ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
