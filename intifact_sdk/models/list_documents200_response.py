...
class ListDocuments200Response(BaseModel):
    """
    ListDocuments200Response
    """ # noqa: E501
    success: StrictBool
    data: List[ListDocuments200ResponseDataInner]
    pagination: ListDocuments200ResponsePagination
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ListDocuments200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "pagination": ListDocuments200ResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
