...
class ApiV1InvoiceSendPostRequestFormaPagoInner(BaseModel):
    """
    ...
    cuota: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]] = 0
    fecha_pago: Optional[StrictStr] = Field(alias="fechaPago")
    __properties: ClassVar[List[str]] = ["tipo", "monto", "cuota", "fechaPago"]

    @field_validator('tipo')
    def tipo_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Contado', 'Credito']):
            raise ValueError("must be one of enum values ('Contado', 'Credito')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tipo": obj.get("tipo"),
            "monto": obj.get("monto"),
            "cuota": obj.get("cuota") if obj.get("cuota") is not None else 0,
