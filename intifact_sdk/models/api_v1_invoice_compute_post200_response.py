...
class ApiV1InvoiceComputePost200Response(BaseModel):
    """
    ApiV1InvoiceComputePost200Response
    """ # noqa: E501
    success: StrictBool
    message: Optional[StrictStr]
    data: ApiV1InvoiceComputePost200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ApiV1InvoiceComputePost200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
