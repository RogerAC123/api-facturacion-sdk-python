...
class SearchProductoSunat200ResponseData(BaseModel):
    """
    ...
    items: List[ExportProductoSunat200ResponseDataItemsInner]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["version", "q", "total", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "q": obj.get("q"),
            "total": obj.get("total"),
            "items": [ExportProductoSunat200ResponseDataItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
