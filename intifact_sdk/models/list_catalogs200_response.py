...
class ListCatalogs200Response(BaseModel):
    """
    ListCatalogs200Response
    """ # noqa: E501
    success: StrictBool
    data: List[ListCatalogs200ResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ListCatalogs200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
