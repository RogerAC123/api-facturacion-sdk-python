...
class ExportProductoSunat200Response(BaseModel):
    """
    ExportProductoSunat200Response
    """ # noqa: E501
    success: StrictBool
    data: ExportProductoSunat200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ExportProductoSunat200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
