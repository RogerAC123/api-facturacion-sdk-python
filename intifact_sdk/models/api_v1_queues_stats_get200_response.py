...
class ApiV1QueuesStatsGet200Response(BaseModel):
    """
    ApiV1QueuesStatsGet200Response
    """ # noqa: E501
    success: StrictBool
    data: ApiV1QueuesStatsGet200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ApiV1QueuesStatsGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
