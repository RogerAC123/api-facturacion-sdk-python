...
class ApiV1CatalogsGet200Response(BaseModel):
    """
    ApiV1CatalogsGet200Response
    """ # noqa: E501
    success: StrictBool
    data: List[ApiV1CatalogsGet200ResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ApiV1CatalogsGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
