...
class GetNextCorrelativo200Response(BaseModel):
    """
    GetNextCorrelativo200Response
    """ # noqa: E501
    success: StrictBool
    data: GetNextCorrelativo200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetNextCorrelativo200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
