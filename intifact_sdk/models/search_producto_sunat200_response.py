...
class SearchProductoSunat200Response(BaseModel):
    """
    SearchProductoSunat200Response
    """ # noqa: E501
    success: StrictBool
    data: SearchProductoSunat200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SearchProductoSunat200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
