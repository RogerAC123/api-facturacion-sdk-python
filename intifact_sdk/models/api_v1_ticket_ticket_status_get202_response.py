...
class ApiV1TicketTicketStatusGet202Response(BaseModel):
    """
    ApiV1TicketTicketStatusGet202Response
    """ # noqa: E501
    success: StrictBool
    message: Optional[StrictStr]
    status_code: Optional[StrictStr] = Field(alias="statusCode")
    cdr_response: Optional[ApiV1TicketTicketStatusGet202ResponseCdrResponse] = Field(default=None, alias="cdrResponse")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "message", "statusCode", "cdrResponse"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of cdr_response
        if self.cdr_response:
            _dict['cdrResponse'] = self.cdr_response.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cdrResponse": ApiV1TicketTicketStatusGet202ResponseCdrResponse.from_dict(obj["cdrResponse"]) if obj.get("cdrResponse") is not None else None
        })
