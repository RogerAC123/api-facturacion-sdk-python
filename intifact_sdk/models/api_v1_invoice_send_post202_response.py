...
class ApiV1InvoiceSendPost202Response(BaseModel):
    """
    ApiV1InvoiceSendPost202Response
    """ # noqa: E501
    success: StrictBool
    message: Optional[StrictStr]
    data: Optional[ApiV1InvoiceSendPost202ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ApiV1InvoiceSendPost202ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
