...
class SendSummary202Response(BaseModel):
    """
    SendSummary202Response
    """ # noqa: E501
    success: StrictBool
    message: Optional[StrictStr]
    data: Optional[SendSummary202ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SendSummary202ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
