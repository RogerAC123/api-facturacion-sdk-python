...
class GetTicketStatus200Response(BaseModel):
    """
    ...
    cdr_response: Optional[GetTicketStatus200ResponseCdrResponse] = Field(default=None, alias="cdrResponse")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cdrResponse": GetTicketStatus200ResponseCdrResponse.from_dict(obj["cdrResponse"]) if obj.get("cdrResponse") is not None else None
        })
