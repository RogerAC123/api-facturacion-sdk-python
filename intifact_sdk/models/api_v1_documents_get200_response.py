...
class ApiV1DocumentsGet200Response(BaseModel):
    """
    ApiV1DocumentsGet200Response
    """ # noqa: E501
    success: StrictBool
    data: List[ApiV1DocumentsGet200ResponseDataInner]
    pagination: ApiV1DocumentsGet200ResponsePagination
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ApiV1DocumentsGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "pagination": ApiV1DocumentsGet200ResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
