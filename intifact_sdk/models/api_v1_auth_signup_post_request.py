...
class ApiV1AuthSignupPostRequest(BaseModel):
    """
    ...
    tenant_name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="tenantName")
    __properties: ClassVar[List[str]] = ["email", "password", "name", "tenantName"]
