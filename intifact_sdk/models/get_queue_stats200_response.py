...
class GetQueueStats200Response(BaseModel):
    """
    GetQueueStats200Response
    """ # noqa: E501
    success: StrictBool
    data: GetQueueStats200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetQueueStats200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
