...
class ApiV1InvoiceSendPostRequestPagosInner(BaseModel):
    """
    ApiV1InvoiceSendPostRequestPagosInner
    """ # noqa: E501
    metodo_pago: Annotated[str, Field(strict=True, max_length=40)] = Field(alias="metodoPago")
    monto: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["metodoPago", "monto"]
