...
class ApiV1DocumentsGet200ResponseDataInnerCompany(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1DocumentsGet200ResponseDataInnerCompany from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if ruc (nullable) is None
        # and model_fields_set contains the field
        if self.ruc is None and "ruc" in self.model_fields_set:
            _dict['ruc'] = None

        # set to None if razon_social (nullable) is None
        # and model_fields_set contains the field
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1DocumentsGet200ResponseDataInnerCompany from a dict"""
        if obj is None:
            return None
