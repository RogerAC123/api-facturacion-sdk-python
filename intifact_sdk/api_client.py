...
from intifact_sdk.configuration import Configuration
from intifact_sdk.api_response import ApiResponse, T as ApiResponseT
import intifact_sdk.models
from intifact_sdk import rest
from intifact_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(intifact_sdk.models, klass)
