...
class TestApiV1AuthLoginPostRequest(unittest.TestCase):
    """ApiV1AuthLoginPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1AuthLoginPostRequest:
        """Test ApiV1AuthLoginPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1AuthLoginPostRequest`
        """
        model = ApiV1AuthLoginPostRequest()
        if include_optional:
    ...
    def testApiV1AuthLoginPostRequest(self):
        """Test ApiV1AuthLoginPostRequest"""
