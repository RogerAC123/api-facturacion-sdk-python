...
class TestUpdateCompanyRequest(unittest.TestCase):
    """UpdateCompanyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCompanyRequest:
        """Test UpdateCompanyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCompanyRequest`
        """
        ...
        if include_optional:
            return UpdateCompanyRequest(
                ...
                cuentas_bancarias = [
                    intifact_sdk.models.create_company_request_cuentas_bancarias_inner.createCompany_request_cuentasBancarias_inner(
                        nombre = '0', 
                        bancos = [
                            ''
                            ], 
    ...
    def testUpdateCompanyRequest(self):
        """Test UpdateCompanyRequest"""
