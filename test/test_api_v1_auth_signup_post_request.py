...
class TestApiV1AuthSignupPostRequest(unittest.TestCase):
    """ApiV1AuthSignupPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1AuthSignupPostRequest:
        """Test ApiV1AuthSignupPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1AuthSignupPostRequest`
        """
        model = ApiV1AuthSignupPostRequest()
        if include_optional:
            return ApiV1AuthSignupPostRequest(
    ...
    def testApiV1AuthSignupPostRequest(self):
        """Test ApiV1AuthSignupPostRequest"""
